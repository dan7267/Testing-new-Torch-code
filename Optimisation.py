...
def produce_slopes_one_simulation(paradigm, model_type, sigma, a, b, k, n_jobs, n_simulations):
...
def produce_slopes_multiple_simulations(sigma, a, b, k, model_type, paradigm, n_jobs):
    ...
    simulation = True
    j, ind, reset_after, _ = paradigm_setting(paradigm, cond1, cond2)
    results = produce_slopes_one_simulation(paradigm, model_type, sigma, a, b, k, n_jobs, n_simulations)
    return results
...
def optimise_model(a_param, b_param, log_sigma_param, raw_k_param, n_steps, lr, model_type, paradigm, empirical_data, weights):
    ...
    for step in range(n_steps):
        ...
        simulated_data = produce_slopes_multiple_simulations(sigma_param, a_param, b_param, k_param, model_type, paradigm, n_jobs)
